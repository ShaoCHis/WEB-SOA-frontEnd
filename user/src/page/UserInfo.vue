  ...
  <div class="mainContainer">
    ...
    <div class="contentContainer">
      ...
      <el-card class="patients-info">
        <el-descriptions class="margin-top1"
                         title="患者信息"
                         :column="2"
                         :size="size"
                         border>
          <template slot="extra">
            <el-button v-if="isUpdating == false && dialogFormVisible2 == false"
                       style="margin-right: 10px"
                       type="success"
                       size="small"
                       @click="dialogFormVisible1 = true">添加患者</el-button>
            <el-button v-if="dialogFormVisible2 == true"
                       style="margin-right: 10px"
                       type="danger"
                       size="small"
                       @click="confirmDelete">确认删除</el-button>
            <el-dialog title="添加患者"
              ...
              <el-form :model="addForm"
                ...
                <el-form-item label="身份证号"
                  ...
                  <el-input style="width: 90%"
                            v-model="addForm.patientId"></el-input>
                </el-form-item>
                ...
                <el-form-item label="性别"
                  ...
                  <el-select v-model="addForm.sex"
                    ...
                    <el-option :label="options1[0].label"
                               :value="options1[0].role">
                    </el-option>
                    <el-option :label="options1[1].label"
                ...
                <el-form-item label="手机号"
                              prop="phoneNumber">
                  <el-input style="width: 90%"
                            v-model="addForm.phoneNumber"></el-input>
                </el-form-item>
                <el-form-item label="保险"
                              prop="isInsure">
                  <el-select v-model="addForm.isInsure"
                             placeholder="请选择是否购买保险"
                             prefix>
                    <el-option :label="options2[0].label"
                               :value="options2[0].role">
                    </el-option>
                    <el-option :label="options2[1].label"
              ...
              <div slot="footer"
                ...
                <el-button type="success"
                           @click="addPatientById('addForm')">保存</el-button>
            ...
            <el-button v-if="isUpdating == false && dialogFormVisible2 == false"
                       type="danger"
                       size="small"
                       @click="dialogFormVisible2 = true">删除患者</el-button>
            <el-button v-if="dialogFormVisible2 == true"
                       type="info"
                       size="small"
        ...
        <el-collapse v-model="activeNames"
                     ...
                     :key="index"
                     accordion>
          <el-collapse-item :title="item.index"
                            :name="index">
            <el-descriptions class="margin-top1"
                             :title="item.index"
                             :column="2"
              ...
              >修改信息</el-button
            > -->
                <el-checkbox v-show="dialogFormVisible2 == true"
                             v-model="isDeleteChosen[index]">删除该患者</el-checkbox>
                <!-- 修改信息 -->
                <!-- <el-dialog
              title="修改信息"
              :visible.sync="dialogFormVisible1"
            ...
            >
              ...
              <el-descriptions-item>
                ...
                <el-tag v-if="item.isInsure == 1"
                        size="small"
                        type="success">有</el-tag>
                <el-tag v-if="item.isInsure == 0"
                        size="small"
                        type="danger">无</el-tag>
              </el-descriptions-item>
              <el-descriptions-item v-show="item.isUpdating == '0'">
                <template slot="label">
              ...
              <el-descriptions-item v-show="item.isUpdating == '0'">
                ...
                <el-tag v-if="item.isInsure == 1"
                        size="small"
                        type="primary">医保卡</el-tag>
              </el-descriptions-item>

              <el-button v-if="item.isUpdating == '1'"
                         style="margin-left: 45%; margin-top: 5px"
                         type="success"
                         size="small"
                         @click="confirmUpdate">确认</el-button>
        ...
        <el-collapse v-model="activeNames1"
          ...
          <el-collapse-item :title="item.index"
            ...
            <el-descriptions class="margin-top1"
                             ...
                             border>
              <template slot="extra">
                <el-button v-if="item.state == '0' && item.cardType == '0'"
                           style="margin-right: 10px"
                           type="success"
                           size="small"
                           @click="payByWeiXin(item.id)">支付费用</el-button>
                <el-button v-if="item.state == '0' && item.cardType != '0'"
                           style="margin-right: 10px"
                           type="success"
                           size="small"
                           @click="payByCard(item.id)">支付费用</el-button>
                ...
                <el-button v-if="item.state == '0'"
                           ...
                           type="danger"
                           size="small"
                           @click="cancelReservationById1(item.id)">取消预约</el-button>
                <el-button v-else-if="item.state == '1'"
                           style="margin-right: 10px"
                           type="danger"
                           size="small"
                           @click="cancelReservationById2(item.id)">取消预约</el-button>
              </template>
              <el-descriptions-item>
                <template slot="label">
              ...
              <el-descriptions-item>
                ...
                <el-tag v-if="item.state == 0"
                        size="small"
                        type="success">已预约</el-tag>
                <el-tag v-if="item.state == 1"
                        size="small"
                        type="success">已支付</el-tag>
                <el-tag v-if="item.state == 2"
                        size="small"
                        type="primary">退款中</el-tag>
                <el-tag v-if="item.state == 3"
                        size="small"
              ...
              <el-descriptions-item>
                ...
                <el-tag v-if="item.cardType == 0"
                        size="small"
                        type="primary">微信支付</el-tag>
                <el-tag v-if="item.cardType == 1"
                        size="small"
                        type="primary">就诊卡</el-tag>
                <el-tag v-if="item.cardType == 2"
                        size="small"
                        type="primary">社保卡</el-tag>
                <el-tag v-if="item.cardType == 3"
                        size="small"
                        type="primary">医保卡</el-tag>
              </el-descriptions-item>
              <el-descriptions-item>
