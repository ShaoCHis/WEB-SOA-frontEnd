<template>
  <div class="mainContainer">
    ...
    <div class="contentContainer">
      ...
      <el-card>
          <div class="hospital-location">医院名称：{{this.registerForm.hospitalName}}</div>
          <div class="hospital-location">科室名称：{{this.registerForm.department}}</div>
          <div class="hospital-location">医生：{{this.registerForm.doctor}}</div>
          <el-divider></el-divider>
          <div class="hospital-location">就诊时间：{{this.registerForm.date}}&nbsp{{this.registerForm.time}}</div>
          <div class="hospital-location">挂号费用：{{this.registerForm.money}}</div>
          <div class="hospital-location">就诊人姓名：{{this.registerForm.userName}}</div>
          <el-button style="margin-top:30px;" type="primary" @click="createOrder()">提交待支付订单</el-button>
      </el-card>
    </div>
    <myfooter></myfooter>
  </div>
