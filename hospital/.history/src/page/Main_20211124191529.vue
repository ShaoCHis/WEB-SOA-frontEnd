  ...
  <div>
    <el-container>
      ...
      <el-container class="hospital">
          <el-aside >
          <el-button type="text" v-if:bulletin=false @click="showNotice()" class="text-css">发布公告</el-button><br />
          <el-button type="text" icon="el-icon-caret-right" @click="showNotice()" class="text-css">发布公告</el-button><br />
