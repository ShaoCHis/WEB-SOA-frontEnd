  ...
  <div>
    <el-container>
      ...
      <el-container class="hospital">
          <el-aside >
          <el-button type="text" v-if="this.form.focus==''" @click="showNotice()" class="text-css">发布公告</el-button><br />
          <el-button type="text" v-if="this.form.focus=='notice'" icon="el-icon-caret-right" class="text-css">发布公告</el-button><br />
