        ...
        >
          ...
          <el-form ref="registerFormRef" :model="registerForm" :rules="registerFormRules" label-width="auto" class="register_form">
                ...
                <!-- <el-form-item label="医院简介" prop="description" class="item-form">
                     <el-input v-model="registerForm.description" prefix-icon="el-icon-lock" type="code" ></el-input>
                </el-form-item> -->
                <!-- 图片 -->
                <!-- <el-form-item label="图片" prop="image" class="item-form">
                     <el-input v-model="registerForm.image" prefix-icon="el-icon-lock" type="code" ></el-input>
                </el-form-item> -->
                <!-- 医院等级 -->
                <el-form-item label="医院等级" prop="level" class="item-form">
                     <el-input v-model="registerForm.level" prefix-icon="el-icon-lock" type="code" ></el-input>
                </el-form-item>
                <el-form-item label="医院等级" prop="role"  > 
                ...
                <!-- <el-form-item label="医院位置" prop="location" class="item-form">
                     <el-input v-model="registerForm.location" prefix-icon="el-icon-lock" type="code" ></el-input>
                </el-form-item> -->
