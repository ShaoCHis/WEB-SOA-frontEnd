  ...
  <div>
    <el-container>
      ...
      <el-container class="hospital">
          <el-aside >
            <div>
              <div vif="this.form.focus==='notice'">
            ...
            <!-- <div>
          <el-button type="text" v-if="form.focus==='notice'" icon="el-icon-caret-right" class="text-css">发布公告</el-button><br />
          <el-button type="text" v-else-if="form.focus===''" @click="showNotice()" class="text-css">发布公告</el-button><br />
          </div> -->
          <div>
              <div v-if="this.form.focus===''">
                <el-button type="text" @click="showRoom()" class="text-css">查看科室情况</el-button><br />
              </div>
            <div v-else-if="this.form.focus==='notice'">
