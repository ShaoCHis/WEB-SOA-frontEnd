  ...
  <div>
    <el-container>
      ...
      <el-container class="hospital">
          <el-aside >
          <el-button type="text" v-if="this.fucus='notice'" @click="showNotice()" class="text-css">发布公告</el-button><br />
          <el-button type="text" v-if="this.fucus='notice'" icon="el-icon-caret-right" @click="showNotice()" class="text-css">发布公告</el-button><br />
