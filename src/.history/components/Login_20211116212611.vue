        ...
        <div class="login_box">
            ...
            <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
                ...
                <el-form-item prop="role"  > 
                   <el-select v-model="loginForm.role" @change="searchSelect(loginForm.role)" placeholder="请选择用户类型"  style="width:100%" prefix>
                ...
                <el-form-item class="btns">
                     ...
                     <el-button type="text" @click="register">没有账号？点此注册</el-button>
                </el-form-item>
            </el-form>
