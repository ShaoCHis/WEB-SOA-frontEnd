        ...
        <el-card>
          <div id="main2" style="overflow-y: auto; width: 500px; height: 400px">
            <el-table :data="monthStatement" border stripe>
              <el-table-column width="250" prop="date" label="月份">
              </el-table-column>
              <el-table-column width="220" prop="money" label="流水金额/元">
              </el-table-column>
            </el-table>
          </div>
        </el-card>
...
export default {
  ...
  methods: {
    ...
    getStatement() {
      ...
      for (var k = 1; k <= 12; k++) {
        getStatementMonth(this.Year.getFullYear(), k)
          .then((response) => {
